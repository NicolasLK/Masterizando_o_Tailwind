...
export function TabItem({ value, title, isSelected = false }: TabItemProps) {
  return (
    ...
    >
      <span className="rounded group-focus-visible:border-violet-300 group-focus-visible:ring-2 group-focus-visible:ring-violet-400 group-focus-visible:ring-offset-4">
        {title}
      </span>
