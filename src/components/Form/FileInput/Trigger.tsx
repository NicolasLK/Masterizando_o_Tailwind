...
export function Trigger() {
  ...
  return (
    <>
      <label
        htmlFor={id}
        className="flex-1 cursor-pointer flex flex-col items-center gap-3 rounded-lg border border-zinc-300 px-6 py-4 text-center text-zinc-500 shadow-sm group hover:border-violet-200 hover:bg-violet-25 hover:to-violet-500 dark:border-zinc-800 dark:hover:border-zinc-700 dark:hover:bg-zinc-800 dark:hover:text-violet-300"
      >
